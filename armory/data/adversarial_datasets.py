...
from armory.data.adversarial import (  # noqa: F401
    ...
    resisc45_densenet121_univpatch_and_univperturbation_adversarial_224x224_v2,
...
def resisc45_adversarial_224x224(
    ...
    return datasets._generator_from_tfds(
        "resisc45_densenet121_univpatch_and_univperturbation_adversarial224x224_v2:1.0.0",
        split_type=split_type,
        batch_size=batch_size,
        epochs=epochs,
        dataset_dir=dataset_dir,
