...
_DL_URL = (
    "/armory/datasets/"
    "resisc45_densenet121_univpatch_and_univperturbation_adversarial_224x224_v2.tar.gz"
)
_LABELS = [
    "airplane",
    "airport",
...
class Resisc45Densenet121UnivpatchAndUnivperturbationAdversarial224x224V2(
