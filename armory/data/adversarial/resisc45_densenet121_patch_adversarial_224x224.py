...
_DESCRIPTION = """\
NWPU-RESISC45 adversarial image dataset for DenseNet121 using Adversarial Patch
...
_CITATION = ""
_DL_URL = "/armory/datasets/resisc45_densenet121_patch_adversarial_224x224.tar.gz"
_PATH = "/armory/datasets/resisc45_densenet121_patch_adversarial_224x224.tar.gz"
_LABELS = [
    "airplane",
    "airport",
    "baseball_diamond",
...
class Resisc45Densenet121PatchAdversarial224x224(tfds.core.GeneratorBasedBuilder):
    # Change to Resisc45UniversalPerturbationAndPatchAdversarial224x224
            ...
            features=tfds.features.FeaturesDict(
                {
                    "images": {
                        ...
                        # "adversarial_perturbation": tfds.features.Tensor(shape=[224, 224, 3], dtype=tf.uint8),
                        "adversarial_patch": tfds.features.Tensor(
                            shape=[224, 224, 3], dtype=tf.uint8
                        ),
                    },
    ...
    def _generate_examples(self, data_dir_path):
        ...
        split_dirs = ["clean", "adversarial_patch"]
        ...
        for label in labels:
            ...
            for imagename in imagenames:
                ...
                adv_patch.sort()
                example = {
                    "images": {"clean": image_clean, "adversarial_patch": adv_patch,},
                    "label": label,
                    "imagename": imagename,
                }
