...
class CarlaOverObjDetTrain(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for carla_over_obj_det_train dataset."""
    ...
    def _info(self) -> tfds.core.DatasetInfo:
        ...
        # TODO(carla_over_obj_det_train): Specifies the tfds.core.DatasetInfo object
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        # TODO(carla_over_obj_det_train): Downloads the data and defines the splits
        # path = dl_manager.download_and_extract("https://todo-data-url")
        path = dl_manager.download_and_extract(_URLS)

        # TODO(carla_over_obj_det_train): Returns the Dict[split names, Iterator[Key, Example]]
        # return {
    ...
    def _generate_examples(self, path):
        """Yields examples."""
        # TODO(carla_over_obj_det_train): Yields (key, example) tuples from the dataset
