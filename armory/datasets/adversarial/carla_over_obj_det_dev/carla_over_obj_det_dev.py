"""carla_over_obj_det_dev dataset."""
...
_URL = "https://armory-public-data.s3.us-east-2.amazonaws.com/carla/carla_over_od_dev_1.0.0.tar.gz"


class CarlaOverObjDetDev(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for carla_over_obj_det_dev dataset."""
