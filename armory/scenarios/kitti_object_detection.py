...
class KittiObjectDetectionTask(Scenario):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        if self.skip_misclassified:
            raise ValueError(
                "skip_misclassified shouldn't be set for kitti_object_detection scenario"
            )
        if self.skip_benign:
            raise ValueError(
                "skip_benign shouldn't be set for kitti_object_detection scenario, as "
    ...
    def finalize_results(self):
        super(KittiObjectDetectionTask, self).finalize_results()
