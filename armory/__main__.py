...
def configure(command_args, prog, description):
    ...
    # TODO: This presumes not a docker context by using HostDefaultPaths instead
    # of paths.runtime_paths() which is mode dependent. This might be okay, if
    # we get the paths fixed in issue #1422
