...
class Evaluator(object):
    ...
    def run(
        ...
        if self.no_docker:
            ...
            try:
                self._run_config(runner, check_run=check_run, num_eval_batches=num_eval_batches)
    ...
    def _run_config(self, runner: ArmoryInstance, check_run=False, num_eval_batches=None) -> None:
