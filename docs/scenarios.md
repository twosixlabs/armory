...
* **Dataset:**
The evaluation dataset is the [CARLA Object Detection dataset](https://carla.org), which includes RGB and depth channels for 165 synthetic images of driving scenes, each of
...
* **Threat Scenario:**
  ...
  * Adversary Operating Environment:
    ...
    * Adaptive attacks will be performed on defenses.
* Adversary Capabilities and Resources
    * Patch size of different size/shape as dictated by the green-screens in the images. In the multimodal case, only RGB channels are to be perturbed.
* **Metrics of Interest:**
  * Primary metrics:
    * mAP
    * Disappearance rate
