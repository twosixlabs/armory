...
| "imagenet_adversarial"         | "adversarial"                  | ILSVRC12 adversarial image dataset for ResNet50 |                              |              | (N, 224, 224, 3) |
uint8 | (N,)  | int64  | 1000 images    |
...
|             `name`             |        `adversarial_key`       |                Description                |               Attack               | Source Split |      x_shape     | x_type  | y_shape | y_type |      Size      |
|:------------------------------:|:------------------------------:|:-----------------------------------------:|:----------------------------------:|:------------:|:----------------:|:------:|:-------:|:------:|:--------------:|
| "gtsrb_poison"                 | None                           | German Traffic Sign Poison Dataset        | Data poisoning    |                |              | (N, 48, 48, 3)   |
float32 | (N,)    | int64  | 2220 images    |
